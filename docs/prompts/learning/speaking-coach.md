...
- `{{SPEAKING_CONCEPT}}`: Nội dung đích cụ thể.
...
Speaking: câu nói ngắn, triển khai lý do/ví dụ, so sánh Part 2 hoặc phát triển Part 3 phù hợp concept. Chỉ nói về pronunciation/fluency khi USER_ERROR_EXAMPLES có acoustic evidence; không chẩn đoán từ transcript, không văn mẫu học thuộc.
