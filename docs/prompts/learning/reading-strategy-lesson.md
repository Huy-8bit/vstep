...
- `{{READING_CONCEPT}}`: Nội dung đích cụ thể.
...
Reading: phân biệt evidence với giả định; lấy một đoạn ví dụ tự đủ nghĩa, dạy cách loại distractors và nêu vì sao key được hỗ trợ. Không đoán người học đã suy nghĩ gì hoặc chỉ dẫn scan khi bài yêu cầu inference.
