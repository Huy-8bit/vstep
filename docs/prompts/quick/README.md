...
| --- | --- | --- | --- | --- | --- | --- |
| Writing Task 1 | [quick/quick-grade-writing-task1.md](quick-grade-writing-task1.md) | QUESTION, STUDENT_ANSWER | Báo cáo Markdown | Có | Không | Không |
| Writing Task 2 | [quick/quick-grade-writing-task2.md](quick-grade-writing-task2.md) | QUESTION, STUDENT_ANSWER | Báo cáo Markdown | Có | Không | Không |
| Speaking text | [quick/quick-grade-speaking.md](quick-grade-speaking.md) | QUESTION, TRANSCRIPT | Báo cáo Markdown | Có | Không | Không |
| Giải thích Reading | [quick/quick-explain-reading.md](quick-explain-reading.md) | PASSAGE, QUESTION, OPTIONS | Báo cáo Markdown | Có | Không | Không |
| Vocabulary Coach | [quick/quick-vocabulary-coach.md](quick-vocabulary-coach.md) | SOURCE_SKILL, SOURCE_TEXT | Báo cáo Markdown | Có | Không | Không |
| Phân tích học tập | [quick/quick-learning-analysis.md](quick-learning-analysis.md) | LEARNER_HISTORY_SUMMARY | Báo cáo Markdown | Có | Không | Không |
