...
- `{{READING_PASSAGE}}`: Nội dung gốc, không phải câu ví dụ AI.
...
- `{{SELECTED_TERM}}`: Có cụm → READING_SELECTED; trống → READING.
...
{{SELECTED_TERM}}
==========================================
Có cụm → READING_SELECTED; trống → READING.
