...
Chỉ sửa lỗi thật, giữ ý, register và tối đa cách dùng từ gốc.
...
NHIỆM VỤ VÀ QUY TẮC:
Chỉ sửa lỗi thật, giữ ý, register và tối đa cách dùng từ gốc.
Mọi trích dẫn phải là đoạn liên tục đúng bài gốc; sửa tối thiểu theo đúng ý, không bịa lỗi. Điểm đã cố định, không thay đổi/ước lượng lại. Không gán điểm của bản tốt hơn cho bài gốc. Chỉ corrected_version; không thêm bài mẫu, không cho điểm mới.

KẾT QUẢ DỄ ĐỌC:
Chỉ corrected_version; không thêm bài mẫu, không cho điểm mới.
```
...
Schema đối chiếu: [CorrectedAnswer](../reference/schemas/CorrectedAnswer.schema.json).
