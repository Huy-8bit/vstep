...
Chấm Task 1 theo core rubric hiện hành, có feedback học tập.
...
- [backend/app/prompts/task1_grader.py](../../../backend/app/prompts/task1_grader.py)
