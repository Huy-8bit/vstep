...
Viết ví dụ học tập dựa trên ý thật của người học.
...
NHIỆM VỤ VÀ QUY TẮC:
Viết ví dụ học tập dựa trên ý thật của người học.
Mọi trích dẫn phải là đoạn liên tục đúng bài gốc; sửa tối thiểu theo đúng ý, không bịa lỗi. Điểm đã cố định, không thay đổi/ước lượng lại. Không gán điểm của bản tốt hơn cho bài gốc. Chỉ improved_b2_version; tiếng Anh tự nhiên, phát triển ý gốc, không từ hiếm hoặc văn mẫu rỗng. Trống/lạc đề thì để trống và giải thích ở human mode.

KẾT QUẢ DỄ ĐỌC:
Chỉ improved_b2_version; tiếng Anh tự nhiên, phát triển ý gốc, không từ hiếm hoặc văn mẫu rỗng. Trống/lạc đề thì để trống và giải thích ở human mode.
```
...
Schema đối chiếu: [ImprovedAnswer](../reference/schemas/ImprovedAnswer.schema.json).
