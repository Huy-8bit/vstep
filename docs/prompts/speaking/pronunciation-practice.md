...
Đối chiếu câu đã đọc với câu đích, không chấm lời nói khác thành bài mẫu.

## When to use

Sau khi nghe mẫu và tự ghi âm đọc lại.

## Required input

- `{{REFERENCE_TEXT}}`: Câu/từ đích thực sự cần đọc.
- `{{AUDIO_FILE}}`: Đính kèm audio người học.
...
{{REFERENCE_TEXT}}
==========================================
Câu/từ đích thực sự cần đọc.
================ AUDIO_FILE ================
{{AUDIO_FILE}}
==========================================
Đính kèm audio người học.
...
MODE=SCRIPTED_PRACTICE. Câu mẫu tối đa 500 ký tự. Không chấm fluency/intonation nếu chỉ có từ đơn. Cho một hướng luyện stress/nhóm hơi dựa trên vấn đề nghe được.

KẾT QUẢ DỄ ĐỌC:
heard_text, reference_coverage, trạng thái đủ bằng chứng, score hoặc null, stress_feedback_vi, issue_vi và practice_tip_vi; không bịa vị trí phoneme.
```
...
Ứng dụng lưu từng lần luyện và audio mẫu; prompt không lưu lịch sử hoặc đánh dấu mastered.
