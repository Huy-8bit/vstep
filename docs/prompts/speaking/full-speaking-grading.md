# Chấm Full Speaking từ transcript
...
Nhìn toàn bộ Part 1–3 và follow-up để đánh giá ngôn ngữ tổng thể.

## When to use

Có toàn bộ chuỗi câu hỏi/câu trả lời của một phiên.

## Required input

- `{{ANSWERS}}`: Mỗi mục: sequence_number, part, question, transcript, status (đã trả lời/bỏ qua).

## Optional input

- `{{MISSING_ANSWERS}}`: Câu thiếu/bỏ qua; không tự bổ sung.
...
{{ANSWERS}}
==========================================
Mỗi mục: sequence_number, part, question, transcript, status (đã trả lời/bỏ qua).
================ MISSING_ANSWERS ================
{{MISSING_ANSWERS}}
==========================================
Câu thiếu/bỏ qua; không tự bổ sung.
...
part=0. Chấm ba tiêu chí ngôn ngữ holistically trên tất cả câu trả lời, không lấy trung bình điểm các part và không bịa trọng số part. Nếu thiếu một phần, nêu coverage; không giả định đề đã đủ. Không có audio, tổng năm tiêu chí vẫn null.
...
Full text dùng part=0, không phải ba điểm part cộng lại. Không tuyên bố mức Speaking tổng khi thiếu acoustic evidence.
